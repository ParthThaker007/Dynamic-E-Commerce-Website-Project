...
<body>
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <!-- Brand -->
    <a class="navbar-brand" href="index.php"><i class="fas fa-mobile-alt"></i>&nbsp;&nbsp;Puma Store</a>
          ...
          <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img src="<?= $row['pimg'] ?>" width="50"></td>
                <td><?= $row['pname'] ?></td>
                <td>
                ...
                <td>
                  <input type="number" class="form-control itemQty" value="<?= $row['pqty'] ?>" style="width:75px;">
                </td>
